...
<div class="app-layout" id="app">
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header">
            ...
            <button class="btn btn-icon sidebar-toggle-btn" id="sidebarCloseBtn" title="Close sidebar">&times;</button>
        </div>
    ...
    <main class="main-panel">
        <!-- Toolbar -->
        <div class="toolbar">
            <button class="btn btn-icon sidebar-toggle" id="sidebarToggleBtn" title="Toggle sidebar">&#9776;</button>
        ...
        <form id="settingsForm">
            ...
            <fieldset>
                ...
                <div class="settings-grid">
                    <div class="form-group">
                        ...
                        <input type="password" name="new_password_user" class="input" placeholder="Leave blank to keep">
                    </div>
                    <div class="form-group">
                        <label>New admin password (min 6 chars)</label>
                        <input type="password" name="new_password_admin" class="input" placeholder="Leave blank to keep">
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset class="danger-zone">
                ...
                <div class="settings-grid">
                    ...
                    <label><input type="checkbox" name="disable_path_restrictions"> Disable path restrictions</label>
                </div>
            </fieldset>
